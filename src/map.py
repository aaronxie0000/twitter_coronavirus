        ...
        with archive.open(filename) as f:
            ...
            for line in f:
                ...
                for hashtag in hashtags:
                    lang = tweet['lang']
                    country = ''
                    if tweet['place'] is None or tweet['place']['country_code'] is None:
                        country = 'N/A'
                    else:
                        country = tweet['place']['country_code']
                    # this does not work: because tweet[place] when empty has place: none
                    # country = tweet.get('place',{}).get('country_code','N/A')
                    if hashtag in text:
