...
Interestingly, there was only about 118 uses of the selected Chinese translation, 13871 uses of the Japanese translated keyword and 315 uses of the selected Korean translation for Coronavirus. This could be because Twitter is not the main form of social media used: for example, in China Twitter is blocked. Still, these abnormally low numbers may suggest that there is an error in the keyword chosen. For example, the Chinese Covid translation chosen was 冠状病毒. While the translation is correct, as a Chinese speaker I rarely hear this term used – instead 新冠 is the more commonly used name. Though I don't speak Japanese or Korean, there could be a similar issue with the other two keywords selected. This is a good example of the challenge of analyzing data of a language I don't speak: though the translation may be correct, it may still be the wrong keyword. This could be addressed by using a greater range of keywords in the future. 
